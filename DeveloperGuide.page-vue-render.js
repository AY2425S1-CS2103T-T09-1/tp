...
with(this){return _c('p',[_v("The "),_c('strong',[_v("API")]),_v(" of this component is specified in "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-T09-1/tp/tree/master/src/main/java/seedu/address/ui/Ui.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Ui.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-T09-1/tp/tree/master/src/main/java/seedu/address/logic/Logic.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-T09-1/tp/tree/master/src/main/java/seedu/address/model/Model.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-T09-1/tp/tree/master/src/main/java/seedu/address/storage/Storage.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Step 1. The user selects a company and executes the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("apply")]),_v(" command with relevant application details (e.g., position and status). The command fetches the selected company and creates a new "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Application")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Step 3. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ApplyCommand")]),_v(" creates an updated "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Company")]),_v(" object containing the newly added application and calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#setCompany()")]),_v(" to replace the old company in the model with the updated one.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 4. The changes are committed to the address book by calling "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook#setCompany()")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("Step 3. The "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("UpdateCommand")]),_v(" creates an updated "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Company")]),_v(" object containing the modified application list and calls "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model#setCompany()")]),_v(" to replace the old company with the updated one.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("Step 4. The changes are committed to the address book using "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook#setCompany()")]),_v(".")])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC01 - Add a company")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User provides incomplete required information for the company (name or email).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. InternBuddy shows an error message.")]),_v(" "),_c('p',[_v("Use case restarts at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. User specifies an optional company information that is empty (address, contact number, or tags).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. InternBuddy shows an error message.")]),_v(" "),_c('p',[_v("Use case restarts at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("1c. User provided email is in wrong format.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1c1. InternBuddy shows an error message.")]),_v(" "),_c('p',[_v("Use case restarts at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("1d. User provided contact number is in wrong format.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1d1. InternBuddy shows an error message.")]),_v(" "),_c('p',[_v("Use case restarts at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("1e. User provides an already saved company.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1e1. InternBuddy shows an error message.")]),_v(" "),_c('p',[_v("Use case restarts at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("1f. User decides not to add the company.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_c('a',{attrs:{"id":"uc03"}}),_v("Use case: UC03 - Find a company by name")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User searches for a company's name.")]),_v(" "),_c('li',[_v("InternBuddy shows the matching company(s).")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extension")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list is empty.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. InternBuddy shows an error message that the list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. User did not provide a name to search.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. InternBuddy shows an error message.")]),_v(" "),_c('p',[_v("Use case restarts at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("1c. User decides not to find a company.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2b. No companies with matching name found.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2b1. InternBuddy shows an error message to indicate no matches found.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC04 - Delete a saved company")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to "),_c('a',{attrs:{"href":"#uc02"}},[_v("list saved companies (UC03)")]),_v(" or "),_c('a',{attrs:{"href":"#uc03"}},[_v("find a company (UC04)")])])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific company in the list.")])]),_v(" "),_c('li',[_c('p',[_v("InternBuddy deletes the company.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2a. User decides not to edit a company.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("3a1. InternBuddy shows an error message.")])]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC05 - Edit company information")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to "),_c('a',{attrs:{"href":"#uc02"}},[_v("list saved companies (UC03)")]),_v(" or "),_c('a',{attrs:{"href":"#uc03"}},[_v("find a company (UC04)")])]),_v(" "),_c('li',[_v("User requests to edit a specific company in the list.")]),_v(" "),_c('li',[_v("InternBuddy edits the company.")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2a. User provides updated information in the wrong format.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. InternBuddy shows an error message.")])]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])]),_v(" "),_c('li',[_c('p',[_v("2b. User provides already existing information.")]),_v(" "),_c('ul',[_c('li',[_v("2b1. InternBuddy shows an error message.")])]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])]),_v(" "),_c('li',[_c('p',[_v("2c. User decides not to edit a company.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("3a1. InternBuddy shows an error message.")])]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC06 - Edit company application status")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to "),_c('a',{attrs:{"href":"#uc02"}},[_v("list saved companies (UC03)")]),_v(" or "),_c('a',{attrs:{"href":"#uc03"}},[_v("find a company (UC04)")])]),_v(" "),_c('li',[_v("User requests to edit a specific company in the list.")]),_v(" "),_c('li',[_v("InternBuddy edits the company.")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2a. User provides updated information in the wrong format.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. InternBuddy shows an error message.")])]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])]),_v(" "),_c('li',[_c('p',[_v("2b. User provides updated information that already exists.")]),_v(" "),_c('ul',[_c('li',[_v("2b1. InternBuddy shows an error message.")])]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])]),_v(" "),_c('li',[_c('p',[_v("2c. User decides not to edit a company.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_v("3a1. InternBuddy shows an error message.")])]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 companies without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("The system should respond to user commands without noticeable lag for most operations.")]),_v(" "),_c('li',[_v("The application should allow for seamless data export in common formats (e.g., CSV or JSON) for external backup or sharing.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("CLI")]),_v(": Command Line Interface, a method of interacting with software using typed commands rather than a graphical interface.")]),_v(" "),_c('li',[_c('strong',[_v("PR")]),_v(": Pull Request, a request submitted by a contributor to merge code changes into a repository's main codebase, commonly used in GitHub for code reviews and collaboration.")]),_v(" "),_c('li',[_c('strong',[_v("CSV")]),_v(": Comma Separated Values, a text file format that uses commas to separate values, and newlines to separate records.")]),_v(" "),_c('li',[_c('strong',[_v("JSON")]),_v(": JavaScript Object Notation, a lightweight data-interchange "),_c('a',{attrs:{"href":"https://www.json.org/json-en.html"}},[_v("format")]),_v(".")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('a',{attrs:{"href":"#internbuddy-developer-guide"}},[_v("back to top")])])}
},function anonymous(
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Thu, 24 Oct 2024, 23:24:36 GMT+8]")])])])}
}];
